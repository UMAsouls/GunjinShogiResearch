...
#大将の設定
JUDGE_TABLE[Piece.General] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
JUDGE_TABLE[Piece.General][Piece.Spy] = int(JudgeFrag.Lose)
JUDGE_TABLE[Piece.General][Piece.LandMine] = int(JudgeFrag.Lose)

#中将の設定
JUDGE_TABLE[Piece.LieutenantGeneral] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#少将の設定
JUDGE_TABLE[Piece.MajorGeneral] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#大佐の設定
JUDGE_TABLE[Piece.Colonel] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#中佐の設定
JUDGE_TABLE[Piece.LieutenantColonel] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#少佐の設定
JUDGE_TABLE[Piece.Major] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#ヒコーキの設定
JUDGE_TABLE[Piece.Plane] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#タンクの設定
JUDGE_TABLE[Piece.Tank] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
...
#地雷の設定
JUDGE_TABLE[Piece.LandMine] = np.full(16, int(JudgeFrag.Win), dtype = np.int8)
