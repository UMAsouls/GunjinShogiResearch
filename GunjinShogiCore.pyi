...
class JudgeBoard:
    ...
    def step(self, arg0: typing.SupportsInt, arg1: Player, arg2: EraseFrag) -> BattleEndFrag:
        ...
    def get(self, x: typing.SupportsInt, y: typing.SupportsInt, p: Player) -> int:
        ... 
    def getDefinedBoard(self, pieces:numpy.typing.NDArray[numpy.int32], player: Player) -> "JudgeBoard":
        ...
